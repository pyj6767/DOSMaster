...
from dosmaster.base.package_version_check import notify_if_new_version
...
from dosmaster.features.d_divide_by_number_of_atoms import Divide_By_Atom_Number
from dosmaster.features.e_average_dos import Average_DOS
from dosmaster.features.f_remove_dos import Remove_DOS
from dosmaster.features.g_change_sign import Change_Sign
from dosmaster.features.h_graph_editor import Graph_Editor
from dosmaster.features.i_axis_optimization import Axis_Optimization
from dosmaster.features.j_import_custom_setting import Import_Custom_Setting
from dosmaster.features.k_save_custom_setting import Save_Custom_Setting
from dosmaster.features.l_import_dosmaster_data import Import_DOSMaster_Data
from dosmaster.features.m_save_dosmaster_data import Save_DOSMaster_Data
from dosmaster.features.n_save_plot_script import Save_Plot_Script
...
def main():
    ...
    while True:
        ...
        print('2 : Project DOS')
        print('3 : Sum DOS')
        print('4 : Divide DOS by the number of atoms')
        print('5 : Average DOS')
        print('6 : Remove specific DOS')
        print('7 : Show only positive/negative part')
        print('8 : Edit graph style')
        print('9 : ylim optimization')
        print('10 : Import global custom setting (in package)')
        print('11 : Save global custom setting (in package)')
        print('12 : Import DOSMaster plot from current directory')
        print('13 : Save DOSMaster plot in current directory')
        print('14 : Save Plot as Scripts using python or gnuplot')
        print('==================================================================================================================')
        ...
        if Input_Work == 'q':
            ...
            graph_config = Divide_By_Atom_Number(data_dict, graph_config)
        elif Input_Work == '5':
